...
window.hypothesisInstall = function (inject) {
  ...
  if (!window.document.evaluate) {
    resources.push('https://hypothes.is/assets/scripts/vendor/polyfills/wgxpath.install.min.js?bab1c82f');
  }
  ...
  if (!urlWorks) {
    resources.push('https://hypothes.is/assets/scripts/vendor/polyfills/url.min.js?de686538');
  }

  if (typeof window.Annotator === 'undefined') {
    resources.push('https://hypothes.is/assets/styles/hypothesis.min.css?2ab936fd');
    resources.push('https://hypothes.is/assets/scripts/hypothesis.min.js?4f22b85c');
  }
