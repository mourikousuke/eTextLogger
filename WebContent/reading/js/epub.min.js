...
define("rsvp/asap",
  ...
  function(__exports__) {
    ...
    function flush() {
      ...
      queue = [];
      try{
      	var getoldPage = Book.getPage();
      	var getoldChapter = Book.getChapter();
    }catch(e){console.log("ERROR : global variable 'oldPage' or 'oldChapter' is not declared.");}
      	if((getoldPage != oldPage || getoldChapter != oldChapter) && (getoldPage != undefined && getoldChapter != undefined)){
    	  oldPage=Book.getPage();
    	  oldChapter=Book.getChapter();
    	  pageChangedFunc();
      }
    }
...
EPUBJS.Book.prototype.getChapter = function(){
	var chapter;
	chapter=this.spinePos;
	return chapter;
}
//get current page number
EPUBJS.Book.prototype.getPage = function(){
	var page;
	page = this.renderer.chapterPos;
	return page;
}
...
EPUBJS.Render.Iframe.prototype.create = function(){
	...
	this.iframe.name="ePubViewerFrame";
...
*/
EPUBJS.Renderer.prototype.nextPage = function(){
	var result = this.page(this.chapterPos + 1);

	var getnewPage=Book.getPage();
	var getnewChapter=Book.getChapter();
	if((getnewPage != oldPage || getnewChapter != oldChapter) && (getnewPage != undefined && getnewChapter != undefined)){
	  	  oldPage=getnewPage;
	  	  oldChapter=getnewChapter;
	  	  pageChangedFunc();
	}
